...
export default function ComposerForm({ user }: { user: string }) {
  ...
  return (
    <motion.form
      ...
      className="vintage-paper rounded-[24px] p-8 md:p-12"
    >
      <div className="relative z-10 space-y-8">
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-transparent text-3xl font-display text-[var(--ink)] placeholder-[var(--ink)]/25 outline-none md:text-4xl"
            required
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={14}
            className="w-full resize-none bg-transparent font-serif text-base leading-[2.2] text-[var(--ink)] placeholder-[var(--ink)]/25 outline-none"
            required
          />
        </div>
