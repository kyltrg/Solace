      ...
      {show && (
        ...
        >
          <div
            ...
            className="group flex cursor-pointer items-center gap-3 rounded-2xl border border-[var(--accent)]/30 bg-gradient-to-br from-[var(--card-bg)]/95 to-[var(--accent-soft)]/30 px-5 py-3 shadow-[0_0_30px_rgba(168,141,114,0.15)] backdrop-blur-2xl transition-all duration-300 hover:border-[var(--accent)]/50 hover:shadow-[0_0_40px_rgba(168,141,114,0.25)]"
          >
            ...
            <span
              ...
              className="ml-1 cursor-pointer rounded-full p-0.5 text-[var(--muted)] transition-colors hover:text-[var(--text)]"
              role="button"
              tabIndex={0}
              aria-label="Dismiss"
            >
